...
const FeaturedCard = ({ product }) => {
  return (
    <div  data-aos="flip-left" className=" relative flex flex-col text-gray-700 bg-white shadow-md rounded-xl bg-clip-border">
      ...
      <div className="p-6 text-center">
        ...
        <p className="block font-sans text-base antialiased font-medium leading-relaxed text-transparent bg-gradient-to-tr from-orange-800 to-orange-400 bg-clip-text">
          Price: ${product.price}
        </p>
      </div>
