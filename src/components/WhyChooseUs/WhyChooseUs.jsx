    ...
    <div className="mb-24 px-4">
      ...
      <div className="max-w-screen-lg mt-12 mx-auto gap-10 lg:gap-20 flex flex-col lg:flex-row">
        <div className="flex flex-col items-center">
          <span>
            <LuBadgeCheck size={60} className="text-orange-600" />
          </span>
          <h3 className="text-xl font-bold text-gray-500 my-4">
            Wide range of brands
          </h3>
          <p className="text-center text-gray-500 w-9/12 lg:w-full">
            Mercedes-Benz is a luxury brand famed for opulence and cutting-edge
            tech. Chevrolet, an American classic, delivers dependable
            performance across trucks, SUVs, and cars.
          </p>
        </div>
        <div className="flex flex-col items-center">
          ...
          <p className="text-center text-gray-500 w-9/12 lg:w-full">
            Embraced and valued by our clients for our steadfast commitment to
            providing reliable, innovative, and high-quality solutions. With a
            foundation built on trust, integrity, trusted and dependable
            partner.
          </p>
        </div>
        <div className="flex flex-col items-center">
